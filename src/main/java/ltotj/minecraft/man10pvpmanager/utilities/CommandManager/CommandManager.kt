...
import ltotj.minecraft.man10pvpmanager.utilities.TextManager.TextManager
...
open class CommandManager(plugin:JavaPlugin,val alias: String, private val pluginTitle:String):CommandExecutor,TabCompleter{
    ...
    fun sendPluginMessage(sender:CommandSender,message:String){
        sender.sendMessage("${pluginTitle}§r${message}")
    }
